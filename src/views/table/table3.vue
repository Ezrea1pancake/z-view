<template>
  <div>
    <table-slot-component ref="tableSlot" :columns="columns" :data="data">
...
<script>
import TableSlotComponent from '@/components/table-slot/table'
      ...
      columns: [
        {
          ...
          render: (h, { row, rowIndex }) => {
            return h(
              'div',
              this.$refs.tableSlot.$scopedSlots.name({
                row,
                rowIndex
              })
            )
        ...
        },
        {
          ...
          render: (h, { row, rowIndex }) => {
            return h(
              'div',
              this.$refs.tableSlot.$scopedSlots.age({
                row,
                rowIndex
              })
            )
        ...
        },
        {
          ...
          render: (h, { row, rowIndex }) => {
            return h(
              'div',
              this.$refs.tableSlot.$scopedSlots.birthday({
                row,
                rowIndex
              })
            )
        ...
        },
        {
          ...
          render: (h, { row, rowIndex }) => {
            return h(
              'div',
              this.$refs.tableSlot.$scopedSlots.address({
                row,
                rowIndex
              })
            )
        ...
        },
        {
          ...
          render: (h, { row, rowIndex }) => {
            return h(
              'div',
              this.$refs.tableSlot.$scopedSlots.action({
                row,
                rowIndex
              })
            )
